...
# H1 deberá leer desde sdtin lo que ingrese el usuario, línea por línea, 
# enviando una señal USR1 al padre en cada línea leida.
# Una vez ingresada una línea, el proceso padre leerá la memoria compartida 
# y mostrará la línea leida por pantalla y enviará una señal USR1 a H2.
# Al recibir la señal USR1, H2 leerá la línea desde la memoria compartida 
# y la escribirá en mayúsculas en el archivo recibido como argumento.
